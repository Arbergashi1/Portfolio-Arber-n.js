...
import webapinett from '../public/assets/webapinett.jpg';
import c1 from '../public/assets/c1.png';
import jav from '../public/assets/jav.png';
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={webapinett} width='64px' height='100px' alt='/' />
              </div>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={c1} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>C#</h3>
              </div>
